...
void DebugObject::Render(ID3D11DeviceContext* immediateContext, const VECTOR4F& scrollValue, bool isWireFrame)
{
	if (!m_instanceData.empty())
	{
		auto camera = Source::CameraControlle::CameraManager::GetInstance();
		m_geomtry->Begin(immediateContext, false, isWireFrame);
